...
//   // ----------------------------------------------------
//   // Update the createUserBoard method in UserBoardModel
...
//       const userBoardEntry = new UserBoard(userBoardData); // Initialize schema
...
//         return null; // Return null if no user board is found
//       }
...
//   // ----------------------------------------------------
//   // Get user board's preferences (metadata)
//   static async getUserBoardPreferences(userID) {
//     try {
//       const userBoard = await this.getUserBoardByUserId(userID);
//       if (!userBoard) throw new Error("User board entry not found");

//       return userBoard.metadata;
//     } catch (error) {
//       throw new Error(
//         `Error retrieving user board preferences: ${error.message}`
//       );
//     }
//   }
...
//       // Add document to assignedDocs
//       userBoard.addAssignedDoc(docData);

//       // Update user board in Firestore
...
//       // Remove document from assignedDocs
